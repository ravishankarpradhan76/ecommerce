    ...
    IconButton(onPressed: () {}, icon: const Icon(Icons.notifications)),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Payment',style: TextStyle(fontSize: 23,fontWeight: FontWeight.w400),),
            SizedBox(height: 30,),
            SingleChildScrollView(
                ...
                child: Column(
                  ...
                  Text('Bank Name',style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold),),
                    SizedBox(height: 18,),
                    Text('**** **** **** 1234',style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),),
                    SizedBox(height: 28,),
                    Row(
                      ...
                      children: [
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Card Holder',style: TextStyle(color: Colors.white, fontSize: 12),),
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Expiry Date',style: TextStyle(color: Colors.white, fontSize: 12),),
                            Text('12/23',style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold),),
                          ],
                        ),
                      ],
                    ),
            ...
            Container(
              ...
              child: Center(child: Text('+ Add Card',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400,color: Colors.white),)),
            ),
            SizedBox(height: 35,),
